...
urlpatterns = [
    ...
    path('get_course_by_name_and_group/<str:course_name>/<str:group>', views.get_course_by_name_and_group,  name='get_course_by_name_and_group'),
    ...
    path('get_a_course_a_student_is_in_filtered_by_student/<str:student_id>/<str:course_name>', views.get_a_course_a_student_is_in_filtered_by_student,  name='get_a_course_a_student_is_in_filtered_by_student'),
]
